package dev.mstefanov.hms.messages;
...
public final class ValidationErrorMessages {
    ...
    public static final String INCORRECT_FIRST_NAME_LENGTH = "Please note that your first name should contain between 2 and 50 characters.";
    public static final String INCORRECT_LAST_NAME_LENGTH = "Please note that your last name should contain between 2 and 50 characters.";
    ...
    public static final String APPOINTMENT_DATE_IN_PAST = "Please note that the appointment date must be in the future";
    ...
    public static final String MISSING_APPOINTMENT_ID = "Please note that appointment id is mandatory upon confirmation.";
